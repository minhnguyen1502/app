...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void updateHike(int id, String name, String location, String date, String level, String description,String vehicle, double length, int parking){
    ...
    public void updateObservation(int id, String observation, String dateOfTime, String comment) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put(Observation.COLUMN_NAME, observation);
        cv.put(Observation.COLUMN_DATE, dateOfTime);
